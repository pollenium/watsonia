...
var UiFormGroupLoginFile = /** @class */ (function (_super) {
    ...
    UiFormGroupLoginFile.prototype.onFile = function (file) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Keystore_1.Keystore.fromFile(file).then(function (keystore) {
                            ...
                            _this.setErrorMessages(true, ['Invalid login file']);
                        })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
    ...
    return UiFormGroupLoginFile;
}(FormGroup_1.UiFormGroup));
exports.UiFormGroupLoginFile = UiFormGroupLoginFile;
