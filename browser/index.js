(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.watsonia = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
"use strict";
...
var Market = /** @class */ (function () {
    function Market(id, name, imageFileName, address) {
        this.id = id;
        this.name = name;
    ...
    Market.prototype.getUrlParts = function () {
        if (this.urlParts) {
    ...
    Market.prototype.getNameSlug = function () {
        if (this.nameSlug) {
    ...
    Market.prototype.fetchToken = function (resolution) {
        var _this = this;
        if (this.tokenPromises[resolution]) {
            return this.tokenPromises[resolution];
        }
        this.tokenPromises[resolution] = new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var tokenAddress;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.fetchTokenAddress(resolution)];
                    case 1:
                        tokenAddress = _a.sent();
                        resolve(new Token_1.Token(tokenAddress));
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    Market.prototype.getImageUrl = function () {
        if (this.imageUrl) {
    ...
    Market.prototype.fetchTokenAddress = function (resolution) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, pollenium_buttercup_1.Address.genNull()];
            });
        });
    };
    return Market;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    now = getTime();
                    if (!(time > now)) return [3 /*break*/, 2];
                    return [4 /*yield*/, delay_1["default"](time - now)];
                case 1:
                    _a.sent();
                    _a.label = 2;
